...
const contractAddress = '0x7c5E52bc7d48EDCE7D2A43a7c433448d428e0dC9'; // Atualize com o novo endereço após reimplantar o contrato
const BACKEND_URL = 'https://backend-leaderboard-production.up.railway.app'; // Para leaderboard
const BACKEND_UR = 'https://palavras-production.up.railway.app'; // Facil, normal e hardcore
...
export const GlobalProvider = ({ children }) => {
  ...
  const initializeContract = async (ethProvider) => {
    try {
      ...
      alert(translations[language].pt ? 'Erro ao conectar com o contrato!' : 'Error connecting to contract!');
    }
  };
  ...
  async function connectWallet(walletType) {
    try {
      ...
      if (walletType === 'metamask' && window.ethereum?.isMetaMask) {
        ...
        alert('Carteira não detectada. Verifique se ela está instalada e ativa.');
        return;
      }
      ...
      if (err.code === 4001) {
        alert(translations[language].pt
